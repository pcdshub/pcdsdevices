...
class Wave8V2SystemRegs(BaseInterface, Device):
    ...
    trigger_enable = Cpt(EpicsSignal, ":TrigEn_RBV", write_pv=":TrigEn", kind="config")
    trigger_source = Cpt(EpicsSignal, ":TrigSrcSel_RBV", write_pv=":TrigSrcSel", kind="config")
    trigger_delay = Cpt(EpicsSignal, ":TrigDelay_RBV", write_pv=":TrigDelay", kind="config")

    a0p3v3_en = Cpt(EpicsSignal, ":A0p3V3En_RBV", write_pv=":A0p3V3En", kind="config")
    a1p3v3_en = Cpt(EpicsSignal, ":A1p3V3En_RBV", write_pv=":A1p3V3En", kind="config")
    ap1v8_en = Cpt(EpicsSignal, ":Ap1V8En_RBV", write_pv=":Ap1V8En", kind="config")
    ap5v0_en = Cpt(EpicsSignal, ":Ap5V0En_RBV", write_pv=":Ap5V0En", kind="config")
    ap5v5_en = Cpt(EpicsSignal, ":Ap5V5En_RBV", write_pv=":Ap5V5En", kind="config")
    avcc_en0 = Cpt(EpicsSignal, ":AvccEn0_RBV", write_pv=":AvccEn0", kind="config")
    avcc_en1 = Cpt(EpicsSignal, ":AvccEn1_RBV", write_pv=":AvccEn1", kind="config")

    adc_ctrl1 = Cpt(EpicsSignal, ":AdcCtrl1_RBV", write_pv=":AdcCtrl1", kind="config")
    adc_ctrl2 = Cpt(EpicsSignal, ":AdcCtrl2_RBV", write_pv=":AdcCtrl2", kind="config")

    adc_reset = Cpt(EpicsSignal, ":AdcReset_RBV", write_pv=":AdcReset", kind="config")

    fpga_tmp_critlatch = Cpt(EpicsSignal, ":FpgaTmpCritLatch_RBV", write_pv=":FpgaTmpCritLatch", kind="config")
...
class Wave8V2RawBuffers(BaseInterface, Device):
    ...
    buffer0_enable = Cpt(EpicsSignal, ":BuffEn0_RBV", write_pv=":BuffEn0", kind="config")
    buffer1_enable = Cpt(EpicsSignal, ":BuffEn1_RBV", write_pv=":BuffEn1", kind="config")
    buffer2_enable = Cpt(EpicsSignal, ":BuffEn2_RBV", write_pv=":BuffEn2", kind="config")
    buffer3_enable = Cpt(EpicsSignal, ":BuffEn3_RBV", write_pv=":BuffEn3", kind="config")
    buffer4_enable = Cpt(EpicsSignal, ":BuffEn4_RBV", write_pv=":BuffEn4", kind="config")
    buffer5_enable = Cpt(EpicsSignal, ":BuffEn5_RBV", write_pv=":BuffEn5", kind="config")
    buffer6_enable = Cpt(EpicsSignal, ":BuffEn6_RBV", write_pv=":BuffEn6", kind="config")
    buffer7_enable = Cpt(EpicsSignal, ":BuffEn7_RBV", write_pv=":BuffEn7", kind="config")

    overflow_cnt_buffer0 = Cpt(EpicsSignal, ":OvflCntBuff0_RBV", write_pv=":OvflCntBuff0", kind="config")
    ...
    overflow_cnt_buffer7 = Cpt(EpicsSignal, ":OvflCntBuff7_RBV", write_pv=":OvflCntBuff7", kind="config")

    buffer_length = Cpt(EpicsSignal, ":BuffLen_RBV", write_pv=":BuffLen", kind="config")

    trigger_prescale = Cpt(EpicsSignal, ":TrigPrescale_RBV", write_pv=":TrigPrescale", kind="config")

    counter_reset = Cpt(EpicsSignal, ":CntRst_RBV", write_pv=":CntRst", kind="config")

    fifo_pause_threshold = Cpt(EpicsSignal, ":FifoPauseThreshold_RBV", write_pv=":FifoPauseThreshold", kind="config")
...
class Wave8V2ADCRegs(BaseInterface, Device):
    ...
    adc_reg_x0006 = Cpt(EpicsSignal, ":AdcReg_0x0006_RBV", write_pv=":AdcReg_0x0006", kind="config")
    adc_reg_x0007 = Cpt(EpicsSignal, ":AdcReg_0x0007_RBV", write_pv=":AdcReg_0x0007", kind="config")
    adc_reg_x0008 = Cpt(EpicsSignal, ":AdcReg_0x0008_RBV", write_pv=":AdcReg_0x0008", kind="config")
    # No x0009, x000A
    adc_reg_x000B = Cpt(EpicsSignal, ":AdcReg_0x000B_RBV", write_pv=":AdcReg_0x000B", kind="config")
    adc_reg_x000C = Cpt(EpicsSignal, ":AdcReg_0x000C_RBV", write_pv=":AdcReg_0x000C", kind="config")
    adc_reg_x000D = Cpt(EpicsSignal, ":AdcReg_0x000D_RBV", write_pv=":AdcReg_0x000D", kind="config")
    # No x000E
    adc_reg_x000F = Cpt(EpicsSignal, ":AdcReg_0x000F_RBV", write_pv=":AdcReg_0x000F", kind="config")
    adc_reg_x0010 = Cpt(EpicsSignal, ":AdcReg_0x0010_RBV", write_pv=":AdcReg_0x0010", kind="config")
    adc_reg_x0011 = Cpt(EpicsSignal, ":AdcReg_0x0011_RBV", write_pv=":AdcReg_0x0011", kind="config")
    adc_reg_x0012 = Cpt(EpicsSignal, ":AdcReg_0x0012_RBV", write_pv=":AdcReg_0x0012", kind="config")
    adc_reg_x0013 = Cpt(EpicsSignal, ":AdcReg_0x0013_RBV", write_pv=":AdcReg_0x0013", kind="config")
    adc_reg_x0014 = Cpt(EpicsSignal, ":AdcReg_0x0014_RBV", write_pv=":AdcReg_0x0014", kind="config")
    adc_reg_x0015 = Cpt(EpicsSignal, ":AdcReg_0x0015_RBV", write_pv=":AdcReg_0x0015", kind="config")
    adc_reg_x0016 = Cpt(EpicsSignal, ":AdcReg_0x0016_RBV", write_pv=":AdcReg_0x0016", kind="config")
    adc_reg_x0017 = Cpt(EpicsSignal, ":AdcReg_0x0017_RBV", write_pv=":AdcReg_0x0017", kind="config")
    adc_reg_x0018 = Cpt(EpicsSignal, ":AdcReg_0x0018_RBV", write_pv=":AdcReg_0x0018", kind="config")
    # No x0019 through x001E
    adc_reg_x001F = Cpt(EpicsSignal, ":AdcReg_0x001F_RBV", write_pv=":AdcReg_0x001F", kind="config")
    adc_reg_x0020 = Cpt(EpicsSignal, ":AdcReg_0x0020_RBV", write_pv=":AdcReg_0x0020", kind="config")
...
class Wave8V2ADCSampleReadout(BaseInterface, Device):
    ...
    convert = Cpt(EpicsSignal, ":Convert_RBV", write_pv=":Convert", kind="config")
...
class Wave8V2AxiVersion(BaseInterface, Device):
    ...
    scratch_pad = Cpt(EpicsSignal, ":ScratchPad_RBV", write_pv=":ScratchPad", kind="config")

    user_reset = Cpt(EpicsSignal, ":UserReset_RBV", write_pv=":UserReset", kind="config")
...
class Wave8V2EventBuilder(BaseInterface, Device):
    ...
    blowoff = Cpt(EpicsSignal, ":Blowoff_RBV", write_pv=":Blowoff", kind="config")
    ...
    timeout = Cpt(EpicsSignal, ":Timeout_RBV", write_pv=":Timeout", kind="config")
...
class Wave8V2EvrV2(BaseInterface, Device):
    ...
    dest_sel = Cpt(EpicsSignal, ":DestSel_RBV", write_pv=":DestSel", kind="config")
    dest_type = Cpt(EpicsSignal, ":DestType_RBV", write_pv=":DestType", kind="config")
    enable_reg = Cpt(EpicsSignal, ":EnableReg_RBV", write_pv=":EnableReg", kind="config")
    enable_trig = Cpt(EpicsSignal, ":EnableTrig_RBV", write_pv=":EnableTrig", kind="config")
    event_code = Cpt(EpicsSignal, ":EventCode_RBV", write_pv=":EventCode", kind="config")
    polarity = Cpt(EpicsSignal, ":Polarity_RBV", write_pv=":Polarity", kind="config")
    rate_type = Cpt(EpicsSignal, ":RateType_RBV", write_pv=":RateType", kind="config")
    source = Cpt(EpicsSignal, ":Source_RBV", write_pv=":Source", kind="config")
...
class Wave8V2Integrators(BaseInterface, Device):
    ...
    integral_size = Cpt(EpicsSignal, ":IntegralSize_RBV", write_pv=":IntegralSize", kind="config")
    integral_signed = Cpt(EpicsSignal, ":IntegralSigned_RBV", write_pv=":IntegralSigned", kind="config")
    baseline_size = Cpt(EpicsSignal, ":BaselineSize_RBV", write_pv=":BaselineSize", kind="config")
    trig_delay = Cpt(EpicsSignal, ":TrigDelay_RBV", write_pv=":TrigDelay", kind="config")
    quadrant_sel = Cpt(EpicsSignal, ":QuadrantSel_RBV", write_pv=":QuadrantSel", kind="config")

    corr_coeff_raw0 = Cpt(EpicsSignal, ":CorrCoefficientRaw0_RBV", write_pv=":CorrCoefficientRaw0", kind="config")
    corr_coeff_raw1 = Cpt(EpicsSignal, ":CorrCoefficientRaw1_RBV", write_pv=":CorrCoefficientRaw1", kind="config")
    corr_coeff_raw2 = Cpt(EpicsSignal, ":CorrCoefficientRaw2_RBV", write_pv=":CorrCoefficientRaw2", kind="config")

    cnt_rst = Cpt(EpicsSignal, ":CntRst_RBV", write_pv=":CntRst", kind="config")

    proc_fifo_pause_thresh = Cpt(EpicsSignal, ":ProcFifoPauseThreshold", kind="config")

    int_fifo_pause_thresh = Cpt(
        EpicsSignal, ":IntFifoPauseThreshold_RBV", write_pv=":IntFifoPauseThreshold", kind="config"
    )
    ...
    proc_fifo_pause_cnt = Cpt(EpicsSignalRO, ":ProcFifoPauseCnt", kind="config")
...
class Wave8V2PgpMon(BaseInterface, Device):
    ...
    rx_eb_overflow_cnt = Cpt(EpicsSignalRO, ":RxStatus:EbOverflowCnt", kind="config")

    rx_frame_cnt = Cpt(EpicsSignalRO, ":RxStatus:FrameCnt", kind="config")

    rx_link_down_cnt = Cpt(EpicsSignalRO, ":RxStatus:LinkDownCnt", kind="config")
    rx_link_error_cnt = Cpt(EpicsSignalRO, ":RxStatus:LinkErrorCnt", kind="config")
    rx_link_ready_cnt = Cpt(EpicsSignalRO, ":RxStatus:LinkReadyCnt", kind="config")
    rx_link_ready = Cpt(EpicsSignalRO, ":RxStatus:LinkReady", kind="config")

    rx_phy_active_cnt = Cpt(EpicsSignalRO, ":RxStatus:PhyActiveCnt", kind="config")
    rx_phy_active = Cpt(EpicsSignalRO, ":RxStatus:PhyActive", kind="config")

    rx_rem_overflow_cnt0 = Cpt(EpicsSignalRO, ":RxStatus:RemOverflowCnt0", kind="config")
    rx_rem_overflow_cnt1 = Cpt(EpicsSignalRO, ":RxStatus:RemOverflowCnt1", kind="config")
    rx_rem_overflow_cnt2 = Cpt(EpicsSignalRO, ":RxStatus:RemOverflowCnt2", kind="config")
    rx_rem_overflow_cnt3 = Cpt(EpicsSignalRO, ":RxStatus:RemOverflowCnt3", kind="config")

    rx_rem_link_ready_cnt = Cpt(EpicsSignalRO, ":RxStatus:RemRxLinkReadyCnt", kind="config")
    rx_rem_link_ready = Cpt(EpicsSignalRO, ":RxStatus:RemRxLinkReady", kind="config")

    tx_frame_cnt = Cpt(EpicsSignalRO, ":TxStatus:FrameCnt", kind="config")

    tx_link_ready_cnt = Cpt(EpicsSignalRO, ":TxStatus:LinkReadyCnt", kind="config")
    tx_link_ready = Cpt(EpicsSignalRO, ":TxStatus:LinkReady", kind="config")

    tx_loc_overflow_cnt0 = Cpt(EpicsSignalRO, ":TxStatus:LocOverflowCnt0", kind="config")
    tx_loc_overflow_cnt1 = Cpt(EpicsSignalRO, ":TxStatus:LocOverflowCnt1", kind="config")
    tx_loc_overflow_cnt2 = Cpt(EpicsSignalRO, ":TxStatus:LocOverflowCnt2", kind="config")
    tx_loc_overflow_cnt3 = Cpt(EpicsSignalRO, ":TxStatus:LocOverflowCnt3", kind="config")

    tx_phy_active_cnt = Cpt(EpicsSignalRO, ":TxStatus:PhyActiveCnt", kind="config")
...
class Wave8V2Timing(BaseInterface, Device):
    ...
    clk_sel = Cpt(EpicsSignal, ":ClkSel_RBV", write_pv=":ClkSel", kind="config")
    ...
    mode_sel_en = Cpt(EpicsSignal, ":ModeSelEn_RBV", write_pv=":ModeSelEn", kind="config")
    mode_sel = Cpt(EpicsSignal, ":ModeSel_RBV", write_pv=":ModeSel", kind="config")
    rx_down = Cpt(EpicsSignal, ":RxDown_RBV", write_pv=":RxDown", kind="config")
    rx_link_up = Cpt(EpicsSignalRO, ":RxLinkUp", kind="config")
    rx_pll_rst = Cpt(EpicsSignal, ":RxPllReset_RBV", write_pv=":RxPllReset", kind="config")
    ...
    use_mini_tpg = Cpt(EpicsSignal, ":UseMiniTpg_RBV", write_pv=":UseMiniTpg", kind="config")
...
class Wave8V2TriggerEventManager(BaseInterface, Device):
    ...
    master_enable = Cpt(EpicsSignal, ":MasterEnable_RBV", write_pv=":MasterEnable", kind="config")
    ...
    partition = Cpt(EpicsSignal, ":Partition_RBV", write_pv=":Partition", kind="config")

    pause_threshold = Cpt(EpicsSignal, ":PauseThreshold_RBV", write_pv=":PauseThreshold", kind="config")
    ...
    trigger_delay = Cpt(EpicsSignal, ":TriggerDelay_RBV", write_pv=":TriggerDelay_RBV", kind="config")
...
class Wave8V2XpmMini(BaseInterface, Device):
    ...
    config_l0select_destsel = Cpt(
        EpicsSignal, ":Config_L0Select_DestSel_RBV", write_pv=":Config_L0Select_DestSel", kind="config"
    )
    config_l0select_enabled = Cpt(
        EpicsSignal, ":Config_L0Select_Enabled_RBV", write_pv=":Config_L0Select_Enabled", kind="config"
    )
    config_l0select_ratesel = Cpt(
        EpicsSignal, ":Config_L0Select_RateSel_RBV", write_pv=":Config_L0Select_RateSel", kind="config"
    )
    hw_enable = Cpt(EpicsSignal, ":HwEnable_RBV", write_pv=":HwEnable", kind="config")
...
class Wave8V2XpmMsg(BaseInterface, Device):
    ...
    xpmmsg_partition_delay0 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay0", kind="config")
    xpmmsg_partition_delay1 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay1", kind="config")
    xpmmsg_partition_delay2 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay2", kind="config")
    xpmmsg_partition_delay3 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay3", kind="config")
    xpmmsg_partition_delay4 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay4", kind="config")
    xpmmsg_partition_delay5 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay5", kind="config")
    xpmmsg_partition_delay6 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay6", kind="config")
    xpmmsg_partition_delay7 = Cpt(EpicsSignal, ":XpmMsg:PartitionDelay7", kind="config")

    xpmmsg_rx_id = Cpt(EpicsSignalRO, ":XpmMsg:RxId", kind="config")
    xpmmsg_tx_id = Cpt(EpicsSignal, ":XpmMsg:TxId_RBV", write_pv=":XpmMsg:TxId", kind="config")
...
class Qadc134Sparsification(BaseInterface, Device):
    ...
    sparse_en = Cpt(
        EpicsSignal, ":SPARSE_EN_RBV", write_pv=":SPARSE_EN", kind="config", doc="Enable sparse output arrays"
    )
...
class Qadc134(QadcBase):
    ...
    full_en = Cpt(EpicsSignal, ":FULL_EN_RBV", write_pv=":FULL_EN", kind="config", doc="Enable full size output arrays")

    ichan = Cpt(EpicsSignal, ":ICHAN_RBV", write_pv=":ICHAN", kind="config", doc="Interleave channel")
    interleave = Cpt(
        EpicsSignal, ":INTERLEAVE_RBV", write_pv=":INTERLEAVE", kind="config", doc="Enable interleaving on ichan"
    )
    ...
    trig_delay = Cpt(
        EpicsSignal, ":TRIG_DELAY_RBV", write_pv=":TRIG_DELAY", kind="config", doc="Delay in 156.17 MHz ticks"
    )
    trig_event = Cpt(EpicsSignal, ":TRIG_EVENT_RBV", write_pv=":TRIG_EVENT", kind="config")
    ...
    rawdata0 = Cpt(EpicsSignalRO, ":RAWDATA0", kind="normal", doc="Signal in ADU")
    rawdata1 = Cpt(EpicsSignalRO, ":RAWDATA1", kind="normal", doc="Signal in ADU")
