...
class RSChannel(Device):
    ...
    current = Cpt(EpicsSignal, "CURR", kind="normal", doc="Current Setpoint in Amps")
    current_step = Cpt(
        EpicsSignal, "CURR_STEP", write_pv="CURR_STEP", kind="hinted", doc="Step size for Current in Amps"
    )
    current_twk = Cpt(EpicsSignal, "CURR_TWK", kind="normal")
    select = Cpt(EpicsSignal, "SELECT", kind="normal")
    set_current = Cpt(EpicsSignal, "SET_CURR", write_pv="SET_CURR", kind="hinted", doc="Current Setpoint in Amps")
    set_voltage = Cpt(EpicsSignal, "SET_VOLT", write_pv="SET_VOLT", kind="hinted", doc="Voltage Setpoint in Volts")
    voltage = Cpt(EpicsSignal, "VOLT", kind="normal", doc="Actual Voltage in Volts")
    voltage_step = Cpt(
        EpicsSignal, "VOLT_STEP", write_pv="VOLT_STEP", kind="hinted", doc="Step size for Voltage in Volts"
    )
...
class RohdeSchwarzPowerSupply(Device):
    ...
    re_connect = Cpt(EpicsSignal, ":RECONNECT", kind="normal", doc="Connect button")
    id = Cpt(EpicsSignal, ":IDN", kind="hinted", doc="Device ID")
    remote_mode = Cpt(EpicsSignal, ":MODE", kind="normal", doc="Remote mode")
    output = Cpt(EpicsSignal, ":OUTPUT", kind="normal", doc="Turn on/off all channel outputs")
