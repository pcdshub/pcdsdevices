...
def test_pim_init():
    ...
    FakePIM("Test:Yag", name="test", prefix_det="potato", prefix_zoom="woosh", prefix_led="shiny")
    ...
    FakePIM("Test:Yag", name="test", prefix_det="potato", prefix_zoom="woosh", prefix_focus="blur")
    ...
    FakePIM("Test:Yag", name="test", prefix_det="potato", prefix_zoom="woosh", prefix_focus="blur", prefix_led="shiny")
    FakePIM("Test:Yag", name="test", prefix_det="potato", prefix_focus="blur", prefix_led="shiny")
    FakePIM("Test:Yag", name="test", prefix_zoom="potato", prefix_focus="blur", prefix_led="shiny")
