...
from ..spectrometer import HXRSpectrometer, Kmono, VonHamos4Crystal, VonHamosFE, VonHamosFER
...
def test_vh_init():
    ...
    FakeVH(name="test", prefix_focus="zoom", prefix_energy="buzz", prefix_rot="whirl")
    FakeVH("TST", name="test", prefix_focus="zoom", prefix_energy="buzz", prefix_rot="whirl")
...
def test_spectrometer_disconnected():
    ...
    VonHamosFER("TST3", name="test3", prefix_focus="zoom", prefix_energy="buzz", prefix_rot="whirl")
    VonHamos4Crystal("TST4", name="test4", prefix_focus="zoom", prefix_energy="buzz")
