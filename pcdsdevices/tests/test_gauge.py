...
from ..gauge import GaugeSet, GaugeSetBase, GaugeSetMks, GaugeSetPirani, GaugeSetPiraniMks
...
kw_defaults = {"name": "gauge", "index": 1, "prefix_controller": "CONTROLLER"}


@pytest.mark.parametrize("cls", [GaugeSetPirani, GaugeSetBase, GaugeSetMks, GaugeSetPiraniMks])
