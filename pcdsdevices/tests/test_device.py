...
from ophyd.device import Device, Kind
from ophyd.device import FormattedComponent as FCpt
from ophyd.positioner import SoftPositioner
from ophyd.signal import Signal

from ..device import GroupDevice, InterfaceDevice, to_interface
...
def test_basic_class_good():
    obj = Basic("GLASS", name="jar", apple_prefix="APPLE", sauce_prefix="SAUCE")
