...
from ..inout import InOutPositioner, InOutPVStatePositioner, InOutRecordPositioner, TwinCATInOutPositioner
...
def test_in_if_not_out(fake_tcinout):
    ...
    fake_tcinout.state._run_subs(sub_type=fake_tcinout.state.SUB_META, enum_strs=enums)
