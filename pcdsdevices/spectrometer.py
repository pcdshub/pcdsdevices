...
class TMOSpectrometer(BaseInterface, GroupDevice, LightpathMixin):
    ...
    # sp1k4-att-rtd
    att_rtd_01 = Cpt(PytmcSignal, ':RTD:01:TEMP', doc="solid attenuator 01 PT100", io='i', kind='nomal')
    att_rtd_02 = Cpt(PytmcSignal, ':RTD:02:TEMP', doc="solid attenuator 02 PT100", io='i', kind='nomal')
    # Lightpath constants
    inserted = True
    removed = False
    transmission = 1
