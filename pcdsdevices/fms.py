...
class PDU_Temp4(Device):
    ...
    sensor1 = FCpt(EpicsSignalRO, "{prefix}:{elevation[0]}:Sensor:1:GetTempValue", kind="hinted")
    sensor2 = FCpt(EpicsSignalRO, "{prefix}:{elevation[1]}:Sensor:2:GetTempValue", kind="hinted")
    sensor3 = FCpt(EpicsSignalRO, "{prefix}:{elevation[2]}:Sensor:1:GetTempValue", kind="hinted")
    sensor4 = FCpt(EpicsSignalRO, "{prefix}:{elevation[3]}:Sensor:2:GetTempValue", kind="hinted")
...
class PDU_Temp6(Device):
    ...
    sensor3 = FCpt(EpicsSignalRO, "{prefix}:{elevation[2]}:Sensor:1:GetTempValue", kind="hinted")
    sensor4 = FCpt(EpicsSignalRO, "{prefix}:{elevation[3]}:Sensor:2:GetTempValue", kind="hinted")
    sensor5 = FCpt(EpicsSignalRO, "{prefix}:{elevation[4]}:Sensor:1:GetTempValue", kind="hinted")
    sensor6 = FCpt(EpicsSignalRO, "{prefix}:{elevation[5]}:Sensor:2:GetTempValue", kind="hinted")
...
class PDU_Temp8(Device):
    ...
    sensor5 = FCpt(EpicsSignalRO, "{prefix}:{elevation[4]}:Sensor:1:GetTempValue", kind="hinted")
    sensor6 = FCpt(EpicsSignalRO, "{prefix}:{elevation[5]}:Sensor:2:GetTempValue", kind="hinted")
    sensor7 = FCpt(EpicsSignalRO, "{prefix}:{elevation[6]}:Sensor:2:GetTempValue", kind="hinted")
    sensor8 = FCpt(EpicsSignalRO, "{prefix}:{elevation[7]}:Sensor:2:GetTempValue", kind="hinted")
...
class PDU_Humidity4(Device):
    ...
    sensor1 = FCpt(EpicsSignalRO, "{prefix}:{elevation[0]}:Sensor:1:GetHumidValue", kind="hinted")
    sensor2 = FCpt(EpicsSignalRO, "{prefix}:{elevation[1]}:Sensor:2:GetHumidValue", kind="hinted")
    sensor3 = FCpt(EpicsSignalRO, "{prefix}:{elevation[2]}:Sensor:1:GetHumidValue", kind="hinted")
    sensor4 = FCpt(EpicsSignalRO, "{prefix}:{elevation[3]}:Sensor:2:GetHumidValue", kind="hinted")
...
class PDU_Humidity6(Device):
    ...
    sensor3 = FCpt(EpicsSignalRO, "{prefix}:{elevation[2]}:Sensor:1:GetHumidValue", kind="hinted")
    sensor4 = FCpt(EpicsSignalRO, "{prefix}:{elevation[3]}:Sensor:2:GetHumidValue", kind="hinted")
    sensor5 = FCpt(EpicsSignalRO, "{prefix}:{elevation[4]}:Sensor:1:GetHumidValue", kind="hinted")
    sensor6 = FCpt(EpicsSignalRO, "{prefix}:{elevation[5]}:Sensor:2:GetHumidValue", kind="hinted")
...
class PDU_Humidity8(Device):
    ...
    sensor5 = FCpt(EpicsSignalRO, "{prefix}:{elevation[4]}:Sensor:1:GetHumidValue", kind="hinted")
    sensor6 = FCpt(EpicsSignalRO, "{prefix}:{elevation[5]}:Sensor:2:GetHumidValue", kind="hinted")
    sensor7 = FCpt(EpicsSignalRO, "{prefix}:{elevation[6]}:Sensor:2:GetHumidValue", kind="hinted")
    Sensor8 = FCpt(EpicsSignalRO, "{prefix}:{elevation[7]}:Sensor:2:GetHumidValue", kind="hinted")
...
class PDU_Load1(Device):
    ...
    sensor1 = FCpt(EpicsSignalRO, "{prefix}:{elevation[0]}GetInfeedLoadValue", kind="hinted")
...
class PDU_Load2(Device):
    ...
    sensor1 = FCpt(EpicsSignalRO, "{prefix}:{elevation[0]}:GetInfeedLoadValue", kind="hinted")
    sensor2 = FCpt(EpicsSignalRO, "{prefix}:{elevation[1]}:GetInfeedLoadValue", kind="hinted")
...
class PDU_Load3(Device):
    ...
    sensor1 = FCpt(EpicsSignalRO, "{prefix}:{elevation[0]}:GetInfeedLoadValue", kind="hinted")
    sensor2 = FCpt(EpicsSignalRO, "{prefix}:{elevation[1]}:GetInfeedLoadValue", kind="hinted")
    sensor3 = FCpt(EpicsSignalRO, "{prefix}:{elevation[2]}:GetInfeedLoadValue", kind="hinted")
...
class PDU_Load4(Device):
    ...
    sensor2 = FCpt(EpicsSignalRO, "{prefix}:{elevation[1]}:GetInfeedLoadValue", kind="hinted")
    sensor3 = FCpt(EpicsSignalRO, "{prefix}:{elevation[2]}:GetInfeedLoadValue", kind="hinted")
    sensor4 = FCpt(EpicsSignalRO, "{prefix}:{elevation[3]}:GetInfeedLoadValue", kind="hinted")
...
@reorder_components(start_with=["sensor_name", "leak_detection"])
...
@reorder_components(start_with=["sensor_name", "temp"])
