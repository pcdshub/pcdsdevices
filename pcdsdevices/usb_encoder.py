...
class UsDigitalUsbEncoder(BaseInterface, Device):
    ...
    tab_whitelist = ["pos", "set_zero", "set_zero_with_axis", "scale", "offset"]
    ...
    def set_zero_with_axis(self):
        ...
        if hasattr(self.linked_axis, "set_current_position"):
            ...
            print(f"Reset encoder {self.name} and axis {self.linked_axis.name} to 0.")
        else:
            print("No axis associated with that encoder,or axis is not settable.\n")
