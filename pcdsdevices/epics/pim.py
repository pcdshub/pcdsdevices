...
class PIMPulnixDetector(PulnixDetector):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.stage_sigs[self.image1.nd_array_port] = 'CAM'
        self.stage_sigs[self.image1.blocking_callbacks] = 'Yes'
        self.stage_sigs[self.image1.enable] = 1

        self.stage_sigs[self.stats2.nd_array_port] = 'CAM'
        self.stage_sigs[self.stats2.blocking_callbacks] = 'Yes'
        self.stage_sigs[self.stats2.compute_statistics] = 'Yes'
        self.stage_sigs[self.stats2.compute_centroid] = 'Yes'
        self.stage_sigs[self.stats2.centroid_threshold] = 200
        self.stage_sigs[self.stats2.min_callback_time] = 0.0
        self.stage_sigs[self.stats2.enable] = 1
